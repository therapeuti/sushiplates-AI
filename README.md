...
>
> 1. **YOLO 모델별로 정확도 및 속도를 테스트**하고, 최적의 모델(YOLOv8s) 선택
> 2. **사용자가 한 눈에 결과를 검토하여 최종 결제금액이 계산되도록** UX를 고려한 웹 프론트엔드 구현
> 3. **모던 웹 기술(HTML5, CSS3, JavaScript)** 활용한 반응형 UI/UX 설계
> 4. **Docker 및 GCP Cloud Build** 기반 배포 자동화
