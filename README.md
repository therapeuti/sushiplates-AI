...
> **📝 프로젝트 개발 과정**
>
> 초기 팀 프로젝트는 YOLO 기반 초밥 접시 감지 백엔드 서버 구축과 Flutter 모바일 앱 개발을 목표로 진행되었습니다. 본 GitHub 저장소에 올린 코드는 팀 프로젝트를 진행하며
1. **YOLO 모델별로 정확도 및 속도를 테스트**하고,
2. **사용자가 한 눈에 결과를 검토하여 최종 결제금액이 계산되도록 하기 위해**
**UX를 고려하여 웹 프론트를 개인적으로 추가 구현하여 완성한 결과물**입니다:
>
